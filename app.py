...
# =========================================================================
# 4. FUNÇÃO DE EXTRAÇÃO REAL DE DADOS DO PDF (TOTALMENTE CORRIGIDA)
# =========================================================================
def extrair_dados_pdf(arquivos_pdf):
    ...
    for numero_chamada, arquivo in enumerate(arquivos_pdf, start=1):
        ...
        # Identificar os metadados do Aluno no PDF - CORRIGIDO PARA 'linha'
        for linha in linhas:
        ...
        # Buscar as linhas de disciplinas e capturar as notas/frequências reais - CORRIGIDO PARA 'linha'
        for linha in linhas:
...
# =========================================================================
    ...
    with m2:
        # Gráfico 1 (Linhas): Frequência por Bimestre
        ...
        # Gráfico 2 (Barras): Notas por Bimestre
