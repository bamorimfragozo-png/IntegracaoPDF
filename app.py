...
# =========================================================================
# 4. FUNÇÃO DE EXTRAÇÃO CORRIGIDA (FREQUÊNCIA POR LINHA DA DISCIPLINA)
# =========================================================================
    ...
    for numero_chamada, arquivo in enumerate(arquivos_pdf, start=1):
        ...
        for linha in linhas:
            ...
            if len(nome_disciplina) > 3:
                mapeamento_disciplinas[nome_disciplina] = {
                    ...
                    'freq_final': freq_final_calc  # Salva a frequência individualizada
                }
        ...
        for nome_disp, blocos in mapeamento_disciplinas.items():
            ...
            dados_finais.append({
                ...
                'Freq. Final': blocos['freq_final'],  # Mapeia a frequência correta extraída
                'Núcleo': nucleo,
                'Observações': ''
            })
